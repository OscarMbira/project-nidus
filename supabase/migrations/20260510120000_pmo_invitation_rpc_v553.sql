-- Migration: PMO invitation RPC + RLS (keep in sync with SQL/v553_bundle_pmo_invitation_rpc_complete.sql).
-- Apply with Supabase CLI: supabase link … && supabase db push
