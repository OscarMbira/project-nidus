 ...
 *
 * Industries 31–50 are NOT generated here — use:
 *   node scripts/generate-v772b-industry-expansion.mjs
 *   → SQL/v772b_seed/ (see INDUSTRY_META_V772B below / NEW_INDUSTRY_META in that script)
 */
import fs from 'fs'
...
/** Industries 31–50 — generated by scripts/generate-v772b-industry-expansion.mjs (not this file). */
// Referenced only for documentation / grep discoverability.
const INDUSTRY_META_V772B = [
