...
import { getVersionHistory } from '../../services/checkpointReportVersionService'
import { format } from 'date-fns'

export default function CheckpointReportRevisionHistory({ reportId }) {
    ...
    <div className="space-y-4">
      <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
        ...
        <p className="text-sm text-blue-700 dark:text-blue-300">
          Complete version history and change tracking for this checkpoint report.
        </p>
      </div>
