...
import { getApprovalStatus } from '../../../services/exceptionReportApprovalService'
import { format } from 'date-fns'

export default function ExceptionReportApprovals({ reportId, onApprove, onReject, mode = 'view' }) {
    ...
    <div className="space-y-4">
      <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
        ...
        <p className="text-sm text-blue-700 dark:text-blue-300">
          Approval status and history for this exception report.
        </p>
      </div>
                ...
                <div className="flex-1">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <h4 className="font-semibold text-gray-900 dark:text-white">
                      {approval.approver_name || approval.approver?.full_name || approval.approver?.email || 'Unknown Approver'}
                    </h4>
