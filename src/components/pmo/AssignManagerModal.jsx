...
export default function AssignManagerModal({
  ...
  return (
    <Modal
      isOpen={open}
      onClose={onClose}
      title={`Assign ${kind} manager`}
      size="md"
      ariaLabelledBy="assign-manager-title"
      footer={
    ...
    >
      <form id="assign-manager-form" onSubmit={handleSubmit} className="space-y-4">
        <p id="assign-manager-title" className="text-sm text-gray-600 dark:text-gray-400">
          <span className="font-medium text-gray-900 dark:text-white">{kind}:</span> {entityName}
        </p>
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-9 pr-3 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-900 text-gray-900 dark:text-white text-sm"
