...
const SimulatorLayout = ({ children }) => {
  ...
  const menuItems = [
    ...
    },
    {
      ...
      path: '/simulator/custom-scenarios',
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
