        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/platform" className="text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white">
                  Project Management
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/resources" className="text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white">
                  Resources
                </Link>
              </li>
              <li>
