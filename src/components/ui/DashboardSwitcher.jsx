 ...
 * 
 * Allows users with both PMO and PM roles to switch between dashboards
 */
...
export default function DashboardSwitcher() {
  ...
  const isPMODashboard = location.pathname.startsWith('/pmo')
  const isPMDashboard = location.pathname.startsWith('/pm')
  ...
  return (
    <div className="relative">
      ...
      >
        ...
        <span>
          {isPMODashboard ? 'PMO Dashboard' : isPMDashboard ? 'PM Dashboard' : 'Dashboard'}
        </span>
        ...
        <>
          ...
          <div className="absolute right-0 mt-2 w-48 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-lg z-20">
            <div className="py-1">
              ...
              >
                <div className="font-medium">PMO Dashboard</div>
                <div className="text-xs text-gray-500 dark:text-gray-400">Governance & Oversight</div>
              </button>
              <button
              ...
              >
                <div className="font-medium">PM Dashboard</div>
                <div className="text-xs text-gray-500 dark:text-gray-400">Project Delivery</div>
              </button>
            </div>
          </div>
        </>
