...
export const PLATFORM_ENTITY_TYPES = {
  ...
  process_template_project_charter: {
    label: 'Project Charter',
    labelPlural: 'Project Charters',
    icon: FileText,
    createRoute: '/pm/process-templates/t/project-charter/new',
    editRoute: (id) => `/pm/process-templates/t/project-charter/${id}/edit`,
  ...
  process_template_assumption_log: {
    label: 'Assumption Log',
    labelPlural: 'Assumption Logs',
    icon: FileText,
    createRoute: '/pm/process-templates/t/assumption-log/new',
    editRoute: (id) => `/pm/process-templates/t/assumption-log/${id}/edit`,
    holdQueueRoute: '/pm/process-templates',
    titleField: 'title',
    requiredFields: ['title'],
    defaultExpiryDays: 14,
  ...
  process_template_project_management_plan: {
    label: 'Project Management Plan',
    labelPlural: 'Project Management Plans',
    icon: FileText,
    createRoute: '/pm/process-templates/t/project-management-plan/new',
    editRoute: (id) => `/pm/process-templates/t/project-management-plan/${id}/edit`,
    holdQueueRoute: '/pm/process-templates',
    titleField: 'title',
    requiredFields: ['title'],
    defaultExpiryDays: 14,
  ...
  process_template_requirements_management_plan: {
    label: 'Requirements Management Plan',
    labelPlural: 'Requirements Management Plans',
    icon: FileText,
    createRoute: '/pm/process-templates/t/requirements-management-plan/new',
    editRoute: (id) => `/pm/process-templates/t/requirements-management-plan/${id}/edit`,
    holdQueueRoute: '/pm/process-templates',
    titleField: 'title',
    requiredFields: ['title'],
    defaultExpiryDays: 14,
  ...
  process_template_requirements_documentation: {
    label: 'Requirements Documentation',
    labelPlural: 'Requirements Documentations',
    icon: FileText,
    createRoute: '/pm/process-templates/t/requirements-documentation/new',
    editRoute: (id) => `/pm/process-templates/t/requirements-documentation/${id}/edit`,
    holdQueueRoute: '/pm/process-templates',
    titleField: 'title',
    requiredFields: ['title'],
    defaultExpiryDays: 14,
  ...
  process_template_wbs_dictionary: {
    label: 'WBS Dictionary',
    labelPlural: 'WBS Dictionarys',
    icon: FileText,
    createRoute: '/pm/process-templates/t/wbs-dictionary/new',
    editRoute: (id) => `/pm/process-templates/t/wbs-dictionary/${id}/edit`,
    holdQueueRoute: '/pm/process-templates',
    titleField: 'title',
    requiredFields: ['title'],
    defaultExpiryDays: 14,
  ...
  process_template_activity_attributes: {
    label: 'Activity Attributes',
    labelPlural: 'Activity Attributess',
    icon: FileText,
    createRoute: '/pm/process-templates/t/activity-attributes/new',
    editRoute: (id) => `/pm/process-templates/t/activity-attributes/${id}/edit`,
    holdQueueRoute: '/pm/process-templates',
    titleField: 'title',
    requiredFields: ['title'],
    defaultExpiryDays: 14,
  ...
  process_template_activity_resource_requirements: {
    label: 'Activity Resource Requirements',
    labelPlural: 'Activity Resource Requirementss',
    icon: FileText,
    createRoute: '/pm/process-templates/t/activity-resource-requirements/new',
    editRoute: (id) => `/pm/process-templates/t/activity-resource-requirements/${id}/edit`,
    holdQueueRoute: '/pm/process-templates',
    titleField: 'title',
    requiredFields: ['title'],
    defaultExpiryDays: 14,
  ...
  process_template_resource_breakdown_structure: {
    label: 'Resource Breakdown Structure',
    labelPlural: 'Resource Breakdown Structures',
    icon: FileText,
    createRoute: '/pm/process-templates/t/resource-breakdown-structure/new',
    editRoute: (id) => `/pm/process-templates/t/resource-breakdown-structure/${id}/edit`,
    holdQueueRoute: '/pm/process-templates',
    titleField: 'title',
    requiredFields: ['title'],
    defaultExpiryDays: 14,
  ...
  process_template_activity_duration_estimates: {
    label: 'Activity Duration Estimates',
    labelPlural: 'Activity Duration Estimatess',
    icon: FileText,
    createRoute: '/pm/process-templates/t/activity-duration-estimates/new',
    editRoute: (id) => `/pm/process-templates/t/activity-duration-estimates/${id}/edit`,
    holdQueueRoute: '/pm/process-templates',
    titleField: 'title',
    requiredFields: ['title'],
    defaultExpiryDays: 14,
  ...
  process_template_cost_management_plan: {
    label: 'Cost Management Plan',
    labelPlural: 'Cost Management Plans',
    icon: FileText,
    createRoute: '/pm/process-templates/t/cost-management-plan/new',
    editRoute: (id) => `/pm/process-templates/t/cost-management-plan/${id}/edit`,
    holdQueueRoute: '/pm/process-templates',
    titleField: 'title',
    requiredFields: ['title'],
    defaultExpiryDays: 14,
  ...
  process_template_activity_cost_estimates: {
    label: 'Activity Cost Estimates',
    labelPlural: 'Activity Cost Estimatess',
    icon: FileText,
    createRoute: '/pm/process-templates/t/activity-cost-estimates/new',
    editRoute: (id) => `/pm/process-templates/t/activity-cost-estimates/${id}/edit`,
    holdQueueRoute: '/pm/process-templates',
    titleField: 'title',
    requiredFields: ['title'],
    defaultExpiryDays: 14,
  ...
  process_template_cost_baseline: {
    label: 'Cost Baseline',
    labelPlural: 'Cost Baselines',
    icon: FileText,
    createRoute: '/pm/process-templates/t/cost-baseline/new',
    editRoute: (id) => `/pm/process-templates/t/cost-baseline/${id}/edit`,
    holdQueueRoute: '/pm/process-templates',
    titleField: 'title',
    requiredFields: ['title'],
    defaultExpiryDays: 14,
  ...
  process_template_resource_management_plan: {
    label: 'Resource Management Plan',
    labelPlural: 'Resource Management Plans',
    icon: FileText,
    createRoute: '/pm/process-templates/t/resource-management-plan/new',
    editRoute: (id) => `/pm/process-templates/t/resource-management-plan/${id}/edit`,
    holdQueueRoute: '/pm/process-templates',
    titleField: 'title',
    requiredFields: ['title'],
    defaultExpiryDays: 14,
  ...
  process_template_stakeholder_engagement_plan: {
    label: 'Stakeholder Engagement Plan',
    labelPlural: 'Stakeholder Engagement Plans',
    icon: FileText,
    createRoute: '/pm/process-templates/t/stakeholder-engagement-plan/new',
    editRoute: (id) => `/pm/process-templates/t/stakeholder-engagement-plan/${id}/edit`,
    holdQueueRoute: '/pm/process-templates',
    titleField: 'title',
    requiredFields: ['title'],
    defaultExpiryDays: 14,
  ...
  process_template_procurement_management_plan: {
    label: 'Procurement Management Plan',
    labelPlural: 'Procurement Management Plans',
    icon: FileText,
    createRoute: '/pm/process-templates/t/procurement-management-plan/new',
    editRoute: (id) => `/pm/process-templates/t/procurement-management-plan/${id}/edit`,
    holdQueueRoute: '/pm/process-templates',
    titleField: 'title',
    requiredFields: ['title'],
    defaultExpiryDays: 14,
  ...
  process_template_quality_checklists: {
    label: 'Quality Checklist',
    labelPlural: 'Quality Checklists',
    icon: FileText,
    createRoute: '/pm/process-templates/t/quality-checklists/new',
    editRoute: (id) => `/pm/process-templates/t/quality-checklists/${id}/edit`,
    holdQueueRoute: '/pm/process-templates',
    titleField: 'title',
    requiredFields: ['title'],
    defaultExpiryDays: 14,
  ...
  process_template_team_performance_assessment: {
    label: 'Team Performance Assessment',
    labelPlural: 'Team Performance Assessments',
    icon: FileText,
    createRoute: '/pm/process-templates/t/team-performance-assessment/new',
    editRoute: (id) => `/pm/process-templates/t/team-performance-assessment/${id}/edit`,
    holdQueueRoute: '/pm/process-templates',
    titleField: 'title',
    requiredFields: ['title'],
    defaultExpiryDays: 14,
  ...
  process_template_make_or_buy_decision: {
    label: 'Make-or-Buy Decision',
    labelPlural: 'Make-or-Buy Decisions',
    icon: FileText,
    createRoute: '/pm/process-templates/t/make-or-buy-decision/new',
    editRoute: (id) => `/pm/process-templates/t/make-or-buy-decision/${id}/edit`,
    holdQueueRoute: '/pm/process-templates',
    titleField: 'title',
    requiredFields: ['title'],
    defaultExpiryDays: 14,
  ...
  process_template_variance_analysis_report: {
    label: 'Variance Analysis Report',
    labelPlural: 'Variance Analysis Reports',
    icon: FileText,
    createRoute: '/pm/process-templates/t/variance-analysis-report/new',
    editRoute: (id) => `/pm/process-templates/t/variance-analysis-report/${id}/edit`,
    holdQueueRoute: '/pm/process-templates',
    titleField: 'title',
    requiredFields: ['title'],
    defaultExpiryDays: 14,
  ...
  process_template_evm_status_report: {
    label: 'EVM Status Report',
    labelPlural: 'EVM Status Reports',
    icon: FileText,
    createRoute: '/pm/process-templates/t/evm-status-report/new',
    editRoute: (id) => `/pm/process-templates/t/evm-status-report/${id}/edit`,
    holdQueueRoute: '/pm/process-templates',
    titleField: 'title',
    requiredFields: ['title'],
    defaultExpiryDays: 14,
  ...
  process_template_scope_acceptance_form: {
    label: 'Scope Acceptance Form',
    labelPlural: 'Scope Acceptance Forms',
    icon: FileText,
    createRoute: '/pm/process-templates/t/scope-acceptance-form/new',
    editRoute: (id) => `/pm/process-templates/t/scope-acceptance-form/${id}/edit`,
    holdQueueRoute: '/pm/process-templates',
    titleField: 'title',
    requiredFields: ['title'],
    defaultExpiryDays: 14,
  ...
  process_template_project_closure_checklist: {
    label: 'Project Closure Checklist',
    labelPlural: 'Project Closure Checklists',
    icon: FileText,
    createRoute: '/pm/process-templates/t/project-closure-checklist/new',
    editRoute: (id) => `/pm/process-templates/t/project-closure-checklist/${id}/edit`,
    holdQueueRoute: '/pm/process-templates',
    titleField: 'title',
    requiredFields: ['title'],
    defaultExpiryDays: 14,
  ...
  process_template_contract_closure_document: {
    label: 'Contract Closure Document',
    labelPlural: 'Contract Closure Documents',
    icon: FileText,
    createRoute: '/pm/process-templates/t/contract-closure-document/new',
    editRoute: (id) => `/pm/process-templates/t/contract-closure-document/${id}/edit`,
    holdQueueRoute: '/pm/process-templates',
    titleField: 'title',
    requiredFields: ['title'],
    defaultExpiryDays: 14,
...
export const SIMULATOR_ENTITY_TYPES = {
  ...
  sim_process_template_project_charter: {
    label: 'Project Charter',
    labelPlural: 'Project Charters',
    icon: FileText,
    createRoute: '/simulator/pm/process-templates/t/project-charter/new',
    editRoute: (id) => `/simulator/pm/process-templates/t/project-charter/${id}/edit`,
    holdQueueRoute: '/simulator/pm/process-templates',
    titleField: 'title',
    requiredFields: ['title'],
    defaultExpiryDays: 14,
    menuParent: 'process_templates',
  ...
  sim_process_template_assumption_log: {
    label: 'Assumption Log',
    labelPlural: 'Assumption Logs',
    icon: FileText,
    createRoute: '/simulator/pm/process-templates/t/assumption-log/new',
    editRoute: (id) => `/simulator/pm/process-templates/t/assumption-log/${id}/edit`,
    holdQueueRoute: '/simulator/pm/process-templates',
    titleField: 'title',
    requiredFields: ['title'],
    defaultExpiryDays: 14,
  ...
  sim_process_template_project_management_plan: {
    label: 'Project Management Plan',
    labelPlural: 'Project Management Plans',
    icon: FileText,
    createRoute: '/simulator/pm/process-templates/t/project-management-plan/new',
    editRoute: (id) => `/simulator/pm/process-templates/t/project-management-plan/${id}/edit`,
    holdQueueRoute: '/simulator/pm/process-templates',
    titleField: 'title',
    requiredFields: ['title'],
    defaultExpiryDays: 14,
  ...
  sim_process_template_requirements_management_plan: {
    label: 'Requirements Management Plan',
    labelPlural: 'Requirements Management Plans',
    icon: FileText,
    createRoute: '/simulator/pm/process-templates/t/requirements-management-plan/new',
    editRoute: (id) => `/simulator/pm/process-templates/t/requirements-management-plan/${id}/edit`,
    holdQueueRoute: '/simulator/pm/process-templates',
    titleField: 'title',
    requiredFields: ['title'],
    defaultExpiryDays: 14,
  ...
  sim_process_template_requirements_documentation: {
    label: 'Requirements Documentation',
    labelPlural: 'Requirements Documentations',
    icon: FileText,
    createRoute: '/simulator/pm/process-templates/t/requirements-documentation/new',
    editRoute: (id) => `/simulator/pm/process-templates/t/requirements-documentation/${id}/edit`,
    holdQueueRoute: '/simulator/pm/process-templates',
    titleField: 'title',
    requiredFields: ['title'],
    defaultExpiryDays: 14,
  ...
  sim_process_template_wbs_dictionary: {
    label: 'WBS Dictionary',
    labelPlural: 'WBS Dictionarys',
    icon: FileText,
    createRoute: '/simulator/pm/process-templates/t/wbs-dictionary/new',
    editRoute: (id) => `/simulator/pm/process-templates/t/wbs-dictionary/${id}/edit`,
    holdQueueRoute: '/simulator/pm/process-templates',
    titleField: 'title',
    requiredFields: ['title'],
    defaultExpiryDays: 14,
  ...
  sim_process_template_activity_attributes: {
    label: 'Activity Attributes',
    labelPlural: 'Activity Attributess',
    icon: FileText,
    createRoute: '/simulator/pm/process-templates/t/activity-attributes/new',
    editRoute: (id) => `/simulator/pm/process-templates/t/activity-attributes/${id}/edit`,
    holdQueueRoute: '/simulator/pm/process-templates',
    titleField: 'title',
    requiredFields: ['title'],
    defaultExpiryDays: 14,
  ...
  sim_process_template_activity_resource_requirements: {
    label: 'Activity Resource Requirements',
    labelPlural: 'Activity Resource Requirementss',
    icon: FileText,
    createRoute: '/simulator/pm/process-templates/t/activity-resource-requirements/new',
    editRoute: (id) => `/simulator/pm/process-templates/t/activity-resource-requirements/${id}/edit`,
    holdQueueRoute: '/simulator/pm/process-templates',
    titleField: 'title',
    requiredFields: ['title'],
    defaultExpiryDays: 14,
  ...
  sim_process_template_resource_breakdown_structure: {
    label: 'Resource Breakdown Structure',
    labelPlural: 'Resource Breakdown Structures',
    icon: FileText,
    createRoute: '/simulator/pm/process-templates/t/resource-breakdown-structure/new',
    editRoute: (id) => `/simulator/pm/process-templates/t/resource-breakdown-structure/${id}/edit`,
    holdQueueRoute: '/simulator/pm/process-templates',
    titleField: 'title',
    requiredFields: ['title'],
    defaultExpiryDays: 14,
  ...
  sim_process_template_activity_duration_estimates: {
    label: 'Activity Duration Estimates',
    labelPlural: 'Activity Duration Estimatess',
    icon: FileText,
    createRoute: '/simulator/pm/process-templates/t/activity-duration-estimates/new',
    editRoute: (id) => `/simulator/pm/process-templates/t/activity-duration-estimates/${id}/edit`,
    holdQueueRoute: '/simulator/pm/process-templates',
    titleField: 'title',
    requiredFields: ['title'],
    defaultExpiryDays: 14,
  ...
  sim_process_template_cost_management_plan: {
    label: 'Cost Management Plan',
    labelPlural: 'Cost Management Plans',
    icon: FileText,
    createRoute: '/simulator/pm/process-templates/t/cost-management-plan/new',
    editRoute: (id) => `/simulator/pm/process-templates/t/cost-management-plan/${id}/edit`,
    holdQueueRoute: '/simulator/pm/process-templates',
    titleField: 'title',
    requiredFields: ['title'],
    defaultExpiryDays: 14,
  ...
  sim_process_template_activity_cost_estimates: {
    label: 'Activity Cost Estimates',
    labelPlural: 'Activity Cost Estimatess',
    icon: FileText,
    createRoute: '/simulator/pm/process-templates/t/activity-cost-estimates/new',
    editRoute: (id) => `/simulator/pm/process-templates/t/activity-cost-estimates/${id}/edit`,
    holdQueueRoute: '/simulator/pm/process-templates',
    titleField: 'title',
    requiredFields: ['title'],
    defaultExpiryDays: 14,
  ...
  sim_process_template_cost_baseline: {
    label: 'Cost Baseline',
    labelPlural: 'Cost Baselines',
    icon: FileText,
    createRoute: '/simulator/pm/process-templates/t/cost-baseline/new',
    editRoute: (id) => `/simulator/pm/process-templates/t/cost-baseline/${id}/edit`,
    holdQueueRoute: '/simulator/pm/process-templates',
    titleField: 'title',
    requiredFields: ['title'],
    defaultExpiryDays: 14,
  ...
  sim_process_template_resource_management_plan: {
    label: 'Resource Management Plan',
    labelPlural: 'Resource Management Plans',
    icon: FileText,
    createRoute: '/simulator/pm/process-templates/t/resource-management-plan/new',
    editRoute: (id) => `/simulator/pm/process-templates/t/resource-management-plan/${id}/edit`,
    holdQueueRoute: '/simulator/pm/process-templates',
    titleField: 'title',
    requiredFields: ['title'],
    defaultExpiryDays: 14,
  ...
  sim_process_template_stakeholder_engagement_plan: {
    label: 'Stakeholder Engagement Plan',
    labelPlural: 'Stakeholder Engagement Plans',
    icon: FileText,
    createRoute: '/simulator/pm/process-templates/t/stakeholder-engagement-plan/new',
    editRoute: (id) => `/simulator/pm/process-templates/t/stakeholder-engagement-plan/${id}/edit`,
    holdQueueRoute: '/simulator/pm/process-templates',
    titleField: 'title',
    requiredFields: ['title'],
    defaultExpiryDays: 14,
  ...
  sim_process_template_procurement_management_plan: {
    label: 'Procurement Management Plan',
    labelPlural: 'Procurement Management Plans',
    icon: FileText,
    createRoute: '/simulator/pm/process-templates/t/procurement-management-plan/new',
    editRoute: (id) => `/simulator/pm/process-templates/t/procurement-management-plan/${id}/edit`,
    holdQueueRoute: '/simulator/pm/process-templates',
    titleField: 'title',
    requiredFields: ['title'],
    defaultExpiryDays: 14,
  ...
  sim_process_template_quality_checklists: {
    label: 'Quality Checklist',
    labelPlural: 'Quality Checklists',
    icon: FileText,
    createRoute: '/simulator/pm/process-templates/t/quality-checklists/new',
    editRoute: (id) => `/simulator/pm/process-templates/t/quality-checklists/${id}/edit`,
    holdQueueRoute: '/simulator/pm/process-templates',
    titleField: 'title',
    requiredFields: ['title'],
    defaultExpiryDays: 14,
  ...
  sim_process_template_team_performance_assessment: {
    label: 'Team Performance Assessment',
    labelPlural: 'Team Performance Assessments',
    icon: FileText,
    createRoute: '/simulator/pm/process-templates/t/team-performance-assessment/new',
    editRoute: (id) => `/simulator/pm/process-templates/t/team-performance-assessment/${id}/edit`,
    holdQueueRoute: '/simulator/pm/process-templates',
    titleField: 'title',
    requiredFields: ['title'],
    defaultExpiryDays: 14,
  ...
  sim_process_template_make_or_buy_decision: {
    label: 'Make-or-Buy Decision',
    labelPlural: 'Make-or-Buy Decisions',
    icon: FileText,
    createRoute: '/simulator/pm/process-templates/t/make-or-buy-decision/new',
    editRoute: (id) => `/simulator/pm/process-templates/t/make-or-buy-decision/${id}/edit`,
    holdQueueRoute: '/simulator/pm/process-templates',
    titleField: 'title',
    requiredFields: ['title'],
    defaultExpiryDays: 14,
  ...
  sim_process_template_variance_analysis_report: {
    label: 'Variance Analysis Report',
    labelPlural: 'Variance Analysis Reports',
    icon: FileText,
    createRoute: '/simulator/pm/process-templates/t/variance-analysis-report/new',
    editRoute: (id) => `/simulator/pm/process-templates/t/variance-analysis-report/${id}/edit`,
    holdQueueRoute: '/simulator/pm/process-templates',
    titleField: 'title',
    requiredFields: ['title'],
    defaultExpiryDays: 14,
  ...
  sim_process_template_evm_status_report: {
    label: 'EVM Status Report',
    labelPlural: 'EVM Status Reports',
    icon: FileText,
    createRoute: '/simulator/pm/process-templates/t/evm-status-report/new',
    editRoute: (id) => `/simulator/pm/process-templates/t/evm-status-report/${id}/edit`,
    holdQueueRoute: '/simulator/pm/process-templates',
    titleField: 'title',
    requiredFields: ['title'],
    defaultExpiryDays: 14,
  ...
  sim_process_template_scope_acceptance_form: {
    label: 'Scope Acceptance Form',
    labelPlural: 'Scope Acceptance Forms',
    icon: FileText,
    createRoute: '/simulator/pm/process-templates/t/scope-acceptance-form/new',
    editRoute: (id) => `/simulator/pm/process-templates/t/scope-acceptance-form/${id}/edit`,
    holdQueueRoute: '/simulator/pm/process-templates',
    titleField: 'title',
    requiredFields: ['title'],
    defaultExpiryDays: 14,
  ...
  sim_process_template_project_closure_checklist: {
    label: 'Project Closure Checklist',
    labelPlural: 'Project Closure Checklists',
    icon: FileText,
    createRoute: '/simulator/pm/process-templates/t/project-closure-checklist/new',
    editRoute: (id) => `/simulator/pm/process-templates/t/project-closure-checklist/${id}/edit`,
    holdQueueRoute: '/simulator/pm/process-templates',
    titleField: 'title',
    requiredFields: ['title'],
    defaultExpiryDays: 14,
  ...
  sim_process_template_contract_closure_document: {
    label: 'Contract Closure Document',
    labelPlural: 'Contract Closure Documents',
    icon: FileText,
    createRoute: '/simulator/pm/process-templates/t/contract-closure-document/new',
    editRoute: (id) => `/simulator/pm/process-templates/t/contract-closure-document/${id}/edit`,
    holdQueueRoute: '/simulator/pm/process-templates',
    titleField: 'title',
    requiredFields: ['title'],
    defaultExpiryDays: 14,
