/**
 * Practice Highlight Report View Page
 */
...
export default function PracticeHighlightReportView() {
  const { id } = useParams()
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="flex justify-between items-start mb-6 flex-wrap gap-3">
        <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Highlight Report</h1>
