...
import { simGetActivity, simSaveActivity, simListWbsNodes } from '../../../services/sim/simPlanningService'
...
export default function ActivityDetail() {
  ...
  const save = async (asHold) => {
    ...
    try {
      ...
      const res = await simSaveActivity(
        projectId,
        {
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-8 dark:bg-gray-950">
      <nav className="mb-4 text-sm text-gray-500 dark:text-gray-400">
        ...
        <Link to={`/simulator/practice-projects/${projectId}/schedule/activities`} className="hover:underline">
          Activities
        </Link>
        <span className="mx-2">/</span>
