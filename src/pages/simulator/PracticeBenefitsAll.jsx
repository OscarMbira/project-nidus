/**
 * Practice Benefits - All Benefits (Simulator)
 * Lists all practice benefits review plans. Route: /simulator/benefits
 */
...
export default function PracticeBenefitsAll() {
  ...
  const loadPlans = async () => {
    try {
      ...
      console.error('Error loading practice benefits:', err)
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h1 className="text-3xl font-bold text-gray-100">All Benefits</h1>
          </div>
          <p className="text-gray-400">
            Practice benefits from Benefits Review Plans across your practice projects.
          </p>
        </div>
        ...
        <div className="bg-gray-800 rounded-lg border border-gray-700 overflow-hidden">
          {filtered.length === 0 ? (
            <div className="p-12 text-center text-gray-400">
              ...
              <p>No practice benefits found. Create a Benefits Review Plan from a practice project.</p>
              <button
                type="button"
