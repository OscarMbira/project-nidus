...
export default function SimProjectTemplateCopyList() {
  ...
  const [viewMode, setViewMode] = useViewMode('sim-template-copy-list', 'list')
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8">
      <div className="flex flex-wrap justify-between gap-2 mb-6">
        <div>
          <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Practice template copies</h1>
          <p className="text-sm text-gray-600 dark:text-gray-400">Copies linked to your simulation runs.</p>
        </div>
