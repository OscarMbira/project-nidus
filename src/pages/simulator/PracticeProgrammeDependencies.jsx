/**
 * Practice Programme Dependencies (Simulator)
 * Mirrors Platform Programme Dependencies: search + table of programmes, select one, show dependency map.
 * Route: /simulator/practice-programme/dependencies
 */

import { useState, useEffect, useMemo } from 'react'
import { GitBranch, Search } from 'lucide-react'
import { getPracticeProgrammesForList, getPracticeProgrammeDependencies } from '../../services/sim/practicePortfolioService'
import DependencyMapVisualization from '../../components/programme/DependencyMapVisualization'

export default function PracticeProgrammeDependenciesPage() {
  ...
  const loadDependencies = async (programmeId) => {
    try {
      ...
      setError(null)
      const data = await getPracticeProgrammeDependencies(programmeId)
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          ...
          <p className="text-gray-400">
            Analyse inter‑project dependencies within a practice programme and highlight critical relationships.
          </p>
        </div>
