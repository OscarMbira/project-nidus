        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          {canEdit && (
            <>
              ...
              <Link
                to={`/platform/projects/${projectId}/scope/requirements/new`}
      ...
      {loading ? (
            ...
            <tbody>
              {filtered.map((r) => (
                <tr key={r.id} className="border-t border-gray-200 dark:border-gray-700">
                  ...
                  <td className="p-3">
                    <Link to={`/platform/projects/${projectId}/scope/requirements/${r.id}`} className="text-blue-600 hover:underline dark:text-blue-400">
                      Open
                    </Link>
                  </td>
                </tr>
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {filtered.map((r) => (
            <Link
              key={r.id}
              to={`/platform/projects/${projectId}/scope/requirements/${r.id}`}
