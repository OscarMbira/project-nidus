/**
 * PMORFPOnHold - RFP drafts on hold (PMO Admin only)
 */
...
export default function PMORFPOnHold() {
  ...
  return (
    <div className="max-w-3xl mx-auto py-8">
      <h1 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">RFP Drafts (On Hold)</h1>
