 ...
 * Route: /app/pmo/organisational-templates
 */
export default function OrganisationalTemplatesPage() {
  ...
  const [viewMode, setViewMode] = useViewMode('pmo-organisational-templates', 'list')
                ...
                <tr key={row.id} className="border-t border-gray-200 bg-white dark:border-gray-700 dark:bg-gray-900">
                  ...
                  <td className="px-3 py-2">
                    <div className="flex items-center gap-2">
                      <Link
                        to={`/app/pmo/organisational-templates/${row.template_reference || row.id}`}
