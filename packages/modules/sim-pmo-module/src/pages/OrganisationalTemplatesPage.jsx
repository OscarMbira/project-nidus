 ...
 * Routes: /simulator/pmo/organisational-templates · /simulator/pm/templates/organisational · /simulator/pm/templates/project
 */
export default function OrganisationalTemplatesPage({ listVariant = 'organisational' } = {}) {
  ...
  const [viewMode, setViewMode] = useViewMode(
    isProjectOwnList ? 'sim-pm-project-templates' : 'sim-pmo-organisational-templates',
    'list',
  )
  ...
  // v852: Simulator — project tier only (no Portfolio/Programme blank-form UI).
  ...
  }, [isProjectOwnList, isProjectScoped, entityId])
  ...
  const openBlankFormModal = () => {
    if (blankFormScope.tier !== 'pmo' && !blankFormScope.scopeEntityId) {
      toast.error('Select a practice project before creating a blank form')
      return
    }
    setBlankFormName('')
