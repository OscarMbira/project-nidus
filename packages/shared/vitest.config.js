...
export default defineConfig({
  ...
  test: {
    ...
    include: [
      ...
      'src/utils/__tests__/invitationInviteeFormat.test.js',
      'src/utils/__tests__/projectRoleDashboardUtils.test.js',
      'src/hooks/__tests__/useSuccessModal.test.jsx',
      'src/hooks/__tests__/usePlatformProjectId.test.jsx',
      'src/hooks/__tests__/useProjectDocumentAccess.test.jsx',
      ...
      'src/utils/__tests__/invitationUrlUtils.test.js',
      'src/utils/__tests__/orgTemplateBulkSelection.test.js',
      'src/utils/__tests__/bulkCopyButtonLabel.test.js',
      ...
      'src/services/__tests__/documentOversightService.test.js',
      'src/services/__tests__/userAvatarService.test.js',
      'src/services/__tests__/signedImageCache.test.js',
