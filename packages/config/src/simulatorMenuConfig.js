...
export const simulatorMenuConfig = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        id: 'sim-forms-practice-starting-up',
        label: 'Starting Up',
        path: '/simulator/pm/projects/:projectId/forms?group=Starting+Up',
        permission: 'form.view',
        subscriptionTier: null,
      },
      {
        id: 'sim-forms-practice-directing',
        label: 'Directing',
        path: '/simulator/pm/projects/:projectId/forms?group=Directing',
        permission: 'form.view',
        subscriptionTier: null,
      },
      {
        id: 'sim-forms-practice-controlling-stage',
        label: 'Controlling a Stage',
        path: '/simulator/pm/projects/:projectId/forms?group=Controlling+a+Stage',
        permission: 'form.view',
        subscriptionTier: null,
      },
      {
        id: 'sim-forms-practice-product-delivery',
        label: 'Managing Product Delivery',
        path: '/simulator/pm/projects/:projectId/forms?group=Managing+Product+Delivery',
        permission: 'form.view',
        subscriptionTier: null,
      },
      {
        id: 'sim-forms-practice-stage-boundary',
        label: 'Managing a Stage Boundary',
        path: '/simulator/pm/projects/:projectId/forms?group=Managing+a+Stage+Boundary',
        permission: 'form.view',
        subscriptionTier: null,
      },
      {
        id: 'sim-forms-practice-backlog',
        label: 'Backlog',
        path: '/simulator/pm/projects/:projectId/forms?group=Backlog',
        permission: 'form.view',
        subscriptionTier: null,
      },
      {
        id: 'sim-forms-practice-sprint-planning',
        label: 'Sprint Planning',
        path: '/simulator/pm/projects/:projectId/forms?group=Sprint+Planning',
        permission: 'form.view',
        subscriptionTier: null,
      },
      {
        id: 'sim-forms-practice-sprint-execution',
        label: 'Sprint Execution',
        path: '/simulator/pm/projects/:projectId/forms?group=Sprint+Execution',
        permission: 'form.view',
        subscriptionTier: null,
      },
      {
        id: 'sim-forms-practice-review-retro',
        label: 'Review & Retrospective',
        path: '/simulator/pm/projects/:projectId/forms?group=Review+%26+Retrospective',
        permission: 'form.view',
        subscriptionTier: null,
      },
      {
        id: 'sim-forms-practice-release',
        label: 'Release',
        path: '/simulator/pm/projects/:projectId/forms?group=Release',
        permission: 'form.view',
        subscriptionTier: null,
      },
      {
