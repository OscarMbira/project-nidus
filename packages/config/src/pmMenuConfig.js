...
export const pmMenuConfig = [
  ...
  // Personal section - My Daily Log Entries
  {
    ...
    children: [
      ...
      { id: 'forms-starting-up', label: 'Starting Up', path: '/platform/projects/:projectId/forms?group=Starting+Up', permission: 'form.view' },
      { id: 'forms-directing', label: 'Directing', path: '/platform/projects/:projectId/forms?group=Directing', permission: 'form.view' },
      { id: 'forms-controlling-stage', label: 'Controlling a Stage', path: '/platform/projects/:projectId/forms?group=Controlling+a+Stage', permission: 'form.view' },
      { id: 'forms-product-delivery', label: 'Managing Product Delivery', path: '/platform/projects/:projectId/forms?group=Managing+Product+Delivery', permission: 'form.view' },
      { id: 'forms-stage-boundary', label: 'Managing a Stage Boundary', path: '/platform/projects/:projectId/forms?group=Managing+a+Stage+Boundary', permission: 'form.view' },
      { id: 'forms-backlog', label: 'Backlog', path: '/platform/projects/:projectId/forms?group=Backlog', permission: 'form.view' },
      { id: 'forms-sprint-planning', label: 'Sprint Planning', path: '/platform/projects/:projectId/forms?group=Sprint+Planning', permission: 'form.view' },
      { id: 'forms-sprint-execution', label: 'Sprint Execution', path: '/platform/projects/:projectId/forms?group=Sprint+Execution', permission: 'form.view' },
      { id: 'forms-review-retro', label: 'Review & Retrospective', path: '/platform/projects/:projectId/forms?group=Review+%26+Retrospective', permission: 'form.view' },
      { id: 'forms-release', label: 'Release', path: '/platform/projects/:projectId/forms?group=Release', permission: 'form.view' },
