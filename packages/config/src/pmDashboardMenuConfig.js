 ...
 * 6. Project Closure
 *
 * @see projectplan/v671 — PM layout sections map to structured / standards_based / agile tracks in useMenu.js
 */
...
const pmDashboardMenuConfig = [
  ...
  // Section 6: Process Group Forms
  {
    ...
    children: [
      ...
      { id: 'pm-forms-starting-up', label: 'Starting Up', path: '/pm/projects/:projectId/forms?group=Starting+Up', icon: FileText, order: 6 },
      { id: 'pm-forms-directing', label: 'Directing', path: '/pm/projects/:projectId/forms?group=Directing', icon: FileText, order: 7 },
      { id: 'pm-forms-controlling-stage', label: 'Controlling a Stage', path: '/pm/projects/:projectId/forms?group=Controlling+a+Stage', icon: FileText, order: 8 },
      { id: 'pm-forms-product-delivery', label: 'Managing Product Delivery', path: '/pm/projects/:projectId/forms?group=Managing+Product+Delivery', icon: FileText, order: 9 },
      { id: 'pm-forms-stage-boundary', label: 'Managing a Stage Boundary', path: '/pm/projects/:projectId/forms?group=Managing+a+Stage+Boundary', icon: FileText, order: 10 },
      { id: 'pm-forms-backlog', label: 'Backlog', path: '/pm/projects/:projectId/forms?group=Backlog', icon: FileText, order: 11 },
      { id: 'pm-forms-sprint-planning', label: 'Sprint Planning', path: '/pm/projects/:projectId/forms?group=Sprint+Planning', icon: FileText, order: 12 },
      { id: 'pm-forms-sprint-execution', label: 'Sprint Execution', path: '/pm/projects/:projectId/forms?group=Sprint+Execution', icon: FileText, order: 13 },
      { id: 'pm-forms-review-retro', label: 'Review & Retrospective', path: '/pm/projects/:projectId/forms?group=Review+%26+Retrospective', icon: FileText, order: 14 },
      { id: 'pm-forms-release', label: 'Release', path: '/pm/projects/:projectId/forms?group=Release', icon: FileText, order: 15 },
