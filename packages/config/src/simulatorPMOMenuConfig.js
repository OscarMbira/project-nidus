...
const simulatorPMOMenuConfig = [
  ...
  // ── Process Group Forms ───────────────────────────────────────────────────────
  {
    ...
    children: [
      ...
      { id: 'sim-pmo-forms-starting-up', label: 'Starting Up', path: '/simulator/pmo/forms?group=Starting+Up', icon: FileText, order: 6, permission: 'form.view_all' },
      { id: 'sim-pmo-forms-directing', label: 'Directing', path: '/simulator/pmo/forms?group=Directing', icon: FileText, order: 7, permission: 'form.view_all' },
      { id: 'sim-pmo-forms-controlling-stage', label: 'Controlling a Stage', path: '/simulator/pmo/forms?group=Controlling+a+Stage', icon: FileText, order: 8, permission: 'form.view_all' },
      { id: 'sim-pmo-forms-product-delivery', label: 'Managing Product Delivery', path: '/simulator/pmo/forms?group=Managing+Product+Delivery', icon: FileText, order: 9, permission: 'form.view_all' },
      { id: 'sim-pmo-forms-stage-boundary', label: 'Managing a Stage Boundary', path: '/simulator/pmo/forms?group=Managing+a+Stage+Boundary', icon: FileText, order: 10, permission: 'form.view_all' },
      { id: 'sim-pmo-forms-backlog', label: 'Backlog', path: '/simulator/pmo/forms?group=Backlog', icon: FileText, order: 11, permission: 'form.view_all' },
      { id: 'sim-pmo-forms-sprint-planning', label: 'Sprint Planning', path: '/simulator/pmo/forms?group=Sprint+Planning', icon: FileText, order: 12, permission: 'form.view_all' },
      { id: 'sim-pmo-forms-sprint-execution', label: 'Sprint Execution', path: '/simulator/pmo/forms?group=Sprint+Execution', icon: FileText, order: 13, permission: 'form.view_all' },
      { id: 'sim-pmo-forms-review-retro', label: 'Review & Retrospective', path: '/simulator/pmo/forms?group=Review+%26+Retrospective', icon: FileText, order: 14, permission: 'form.view_all' },
      { id: 'sim-pmo-forms-release', label: 'Release', path: '/simulator/pmo/forms?group=Release', icon: FileText, order: 15, permission: 'form.view_all' },
      { id: 'sim-pmo-forms-drafts',     label: 'My Drafts',               path: '/simulator/pmo/forms?status=draft',       icon: FileClock,   order: 16, permission: 'form.view_all' },
      { id: 'sim-pmo-forms-approvals',  label: 'Pending Approvals',       path: '/simulator/pmo/forms?status=in_review',   icon: FileCheck,   order: 17, permission: 'form.approve' },
      { id: 'sim-pmo-forms-new-template', label: 'New Template',          path: '/simulator/pmo/forms/new',                icon: FilePlus,    order: 18, permission: 'form_template.manage' },
    ],
  },
