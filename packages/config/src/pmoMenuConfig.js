...
const pmoMenuConfig = [
...

  {
    ...
    children: [
      ...
      // Structured ceremonies (v786 — Admin v189 parity)
      { id: 'pmo-forms-starting-up', label: 'Starting Up', path: '/pmo/forms?group=Starting+Up', icon: FileText, order: 6, permission: 'form.view_all' },
      { id: 'pmo-forms-directing', label: 'Directing', path: '/pmo/forms?group=Directing', icon: FileText, order: 7, permission: 'form.view_all' },
      { id: 'pmo-forms-controlling-stage', label: 'Controlling a Stage', path: '/pmo/forms?group=Controlling+a+Stage', icon: FileText, order: 8, permission: 'form.view_all' },
      { id: 'pmo-forms-product-delivery', label: 'Managing Product Delivery', path: '/pmo/forms?group=Managing+Product+Delivery', icon: FileText, order: 9, permission: 'form.view_all' },
      { id: 'pmo-forms-stage-boundary', label: 'Managing a Stage Boundary', path: '/pmo/forms?group=Managing+a+Stage+Boundary', icon: FileText, order: 10, permission: 'form.view_all' },
      // Agile ceremonies (v786 — Admin v191 parity)
      { id: 'pmo-forms-backlog', label: 'Backlog', path: '/pmo/forms?group=Backlog', icon: FileText, order: 11, permission: 'form.view_all' },
      { id: 'pmo-forms-sprint-planning', label: 'Sprint Planning', path: '/pmo/forms?group=Sprint+Planning', icon: FileText, order: 12, permission: 'form.view_all' },
      { id: 'pmo-forms-sprint-execution', label: 'Sprint Execution', path: '/pmo/forms?group=Sprint+Execution', icon: FileText, order: 13, permission: 'form.view_all' },
      { id: 'pmo-forms-review-retro', label: 'Review & Retrospective', path: '/pmo/forms?group=Review+%26+Retrospective', icon: FileText, order: 14, permission: 'form.view_all' },
      { id: 'pmo-forms-release', label: 'Release', path: '/pmo/forms?group=Release', icon: FileText, order: 15, permission: 'form.view_all' },
      { id: 'pmo-forms-drafts', label: 'My Drafts', path: '/pmo/forms?status=draft', icon: FileClock, order: 16, permission: 'form.view_all' },
      { id: 'pmo-forms-approvals', label: 'Pending Approvals', path: '/pmo/forms?status=in_review', icon: FileCheck, order: 17, permission: 'form.approve' },
      { id: 'pmo-forms-new-template', label: 'New Template', path: '/pmo/forms/new', icon: FilePlus, order: 18, permission: 'form_template.manage' },
    ]
  },
  {
