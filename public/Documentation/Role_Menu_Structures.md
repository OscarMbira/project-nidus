...
**Legend:** `[S]` = Structured · `[P]` = Standards-Based · `[A]` = Agile · *(no badge)* = Universal / Cross-Methodology

> **v800:** New **Templates** section (`plat_sec_templates` / `sim_sec_templates`) with **Template Library** (`/app/pmo/template-library`, `/simulator/pmo/template-library`). Classic Field Templates remain as a child. See `Documentation/Template_Library_Menu_And_Copy_Guide.md`.
...
| **[P] Standards-Based Track** | ✓ | ✓ | ✓ | view | ✓ | ✓ | — | — | — | view | — | — | — | — | — |
| **[A] Agile Track** | ✓ | ✓ | ✓ | view | — | ✓ | — | — | — | — | — | ✓ | ✓ | — | — |
| Reporting | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ | — | ✓ | ✓ |
| Financial | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ | view | view | — | — | — | — | — | — | — |
| Workflows & Approvals | ✓ | ✓ | ✓ | — | — | ✓ | ✓ | — | ✓ | ✓ | ✓ | ✓ | ✓ | — | — |
...
| **[P] Standards-Based Practice** | ✓ | ✓ | ✓ | — | limited |
