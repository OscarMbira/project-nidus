-- =============================================================================
-- v531_invitation_message_templates_seed.sql
-- Phase 13 — Seed default invitation templates for every existing account (idempotent)
-- =============================================================================
...
DO $$ BEGIN RAISE NOTICE 'v531_invitation_message_templates_seed.sql applied'; END $$;
