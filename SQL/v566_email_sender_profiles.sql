-- ============================================================================
-- v566: Email sender profiles (per project type + system default)
--
-- Prerequisites:
--   v49_email_integration.sql (email_configurations)
--   v04_project_core_tables.sql (project_types)
--   v559_email_configurations_rls_fix.sql (can_manage_email_configurations)
-- ============================================================================
...
-- One active profile per project type per email config
...
-- Only one system default per email config
...
DO $$
BEGIN
    RAISE NOTICE 'v566_email_sender_profiles.sql applied';
END $$;
