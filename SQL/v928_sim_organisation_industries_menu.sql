-- ============================================================================
-- v928: SaaS Industry-Aware Tenant Provisioning — Phase 7 sidebar menu (Simulator)
-- ============================================================================
-- Wires simulator/pmo/organisation-industries into the sidebar, nested under Practice
-- Administration (sim_pmo_cat_admin), matching v917's pattern for Manage Menu Bundles.
-- Granted to the same creator-tier roles as v904/v909/v916/v917/v927.
-- ============================================================================
...
WHERE mi.menu_code = 'sim-pmo-organisation-industries'
...
DO $$
BEGIN
  RAISE NOTICE 'v928: Simulator Industries & Capabilities menu item + role grants installed';
END $$;
