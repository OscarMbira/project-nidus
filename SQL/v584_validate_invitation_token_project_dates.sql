-- v584: Expose project planned start/end dates on public invitation accept page
-- Run after v583_validate_invitation_token_organisation.sql
...
COMMENT ON FUNCTION public.validate_invitation_token(VARCHAR) IS
  'Validates project invitation token; returns project, role, inviter, organisation, and planned dates for accept page.';
