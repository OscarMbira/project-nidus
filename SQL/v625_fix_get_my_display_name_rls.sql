-- v625_fix_get_my_display_name_rls.sql
-- Adds SET row_security = off so the SECURITY DEFINER function truly bypasses RLS
-- even in Supabase environments where the function owner is not a full superuser.
...
DO $$ BEGIN RAISE NOTICE 'v625_fix_get_my_display_name_rls.sql applied'; END $$;
