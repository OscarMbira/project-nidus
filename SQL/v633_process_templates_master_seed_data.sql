...
BEGIN
  ...
  INSERT INTO public.assumption_logs (
    ...
    '{"seed_marker":"SEED633","template_slug":"assumption-log","standards_based_group":"initiating","sections":["Assumption ID","Description","Category","Impact if Invalid","Owner","Status","Review Date"],"notes":"PMO master template scaffold for Assumption Log Master Template. Copy to a project workspace and customise."}'::jsonb,
    'active', TRUE, NULL, v_created_by
  );
  ...
  INSERT INTO public.requirements_management_plans (
    ...
    '{"seed_marker":"SEED633","template_slug":"requirements-management-plan","standards_based_group":"planning","sections":["Scope","Roles","Traceability Approach","Workflow","Configuration","Metrics"],"notes":"PMO master template scaffold for Requirements Management Plan Master Template. Copy to a project workspace and customise."}'::jsonb,
    'active', TRUE, NULL, v_created_by
  );
  ...
  INSERT INTO public.requirements_documentation (
    ...
    '{"seed_marker":"SEED633","template_slug":"requirements-documentation","standards_based_group":"planning","sections":["Business Requirements","Stakeholder Requirements","Solution Requirements","Functional Requirements","Non-Functional Requirements","Transition Requirements"],"notes":"PMO master template scaffold for Requirements Documentation Master Template. Copy to a project workspace and customise."}'::jsonb,
    'active', TRUE, NULL, v_created_by
  );
  ...
  INSERT INTO public.activity_attributes (
    ...
    '{"seed_marker":"SEED633","template_slug":"activity-attributes","standards_based_group":"planning","sections":["Activity ID","Activity Name","Activity Type","Predecessors","Successors","Logical Relationships","Leads and Lags","Resource Requirements"],"notes":"PMO master template scaffold for Activity Attributes Master Template. Copy to a project workspace and customise."}'::jsonb,
    'active', TRUE, NULL, v_created_by, NULL
  );
  ...
  INSERT INTO public.resource_breakdown_structure (
    ...
    '{"seed_marker":"SEED633","template_slug":"resource-breakdown-structure","standards_based_group":"planning","sections":["RBS Code","Resource Category","Description","Organisational Unit","Availability","Cost Rate"],"notes":"PMO master template scaffold for Resource Breakdown Structure Master Template. Copy to a project workspace and customise."}'::jsonb,
    'active', TRUE, NULL, v_created_by
  );
  ...
  INSERT INTO public.activity_duration_estimates (
    ...
    '{"seed_marker":"SEED633","template_slug":"activity-duration-estimates","standards_based_group":"planning","sections":["Activity Reference","Estimate Type","Optimistic","Most Likely","Pessimistic","Expected Duration","Assumptions","Constraints"],"notes":"PMO master template scaffold for Activity Duration Estimates Master Template. Copy to a project workspace and customise."}'::jsonb,
    'active', TRUE, NULL, v_created_by, NULL
  );
  ...
  INSERT INTO public.activity_cost_estimates (
    ...
    '{"seed_marker":"SEED633","template_slug":"activity-cost-estimates","standards_based_group":"planning","sections":["Activity Reference","Resource Costs","Material Costs","Other Direct Costs","Contingency","Total Estimate","Basis of Estimate"],"notes":"PMO master template scaffold for Activity Cost Estimates Master Template. Copy to a project workspace and customise."}'::jsonb,
    'active', TRUE, NULL, v_created_by, NULL
  );
  ...
  INSERT INTO public.quality_checklists (
    ...
    '{"seed_marker":"SEED633","template_slug":"quality-checklists","standards_based_group":"executing","sections":["Deliverable Reference","Quality Standards","Inspection Steps","Acceptance Criteria","Sign-off"],"notes":"PMO master template scaffold for Quality Checklist Master Template. Copy to a project workspace and customise."}'::jsonb,
    'active', TRUE, NULL, v_created_by
  ...
  INSERT INTO public.team_performance_assessments (
    ...
    '{"seed_marker":"SEED633","template_slug":"team-performance-assessment","standards_based_group":"executing","sections":["Assessment Period","Team Objectives","Performance Indicators","Observations","Improvement Actions","Acknowledgement"],"notes":"PMO master template scaffold for Team Performance Assessment Master Template. Copy to a project workspace and customise."}'::jsonb,
    'active', TRUE, NULL, v_created_by
  );
  ...
  INSERT INTO public.variance_analysis_reports (
    ...
    '{"seed_marker":"SEED633","template_slug":"variance-analysis-report","standards_based_group":"monitoring-controlling","sections":["Reporting Period","Baseline Reference","Schedule Variance","Cost Variance","Scope Variance","Root Causes","Corrective Actions"],"notes":"PMO master template scaffold for Variance Analysis Report Master Template. Copy to a project workspace and customise."}'::jsonb,
    'active', TRUE, NULL, v_created_by
  );
  ...
  INSERT INTO public.evm_status_reports (
    ...
    '{"seed_marker":"SEED633","template_slug":"evm-status-report","standards_based_group":"monitoring-controlling","sections":["Control Account","Planned Value (PV)","Earned Value (EV)","Actual Cost (AC)","CPI / SPI","EAC / ETC","Variance Narrative"],"notes":"PMO master template scaffold for Earned Value Status Report Master Template. Copy to a project workspace and customise."}'::jsonb,
    'active', TRUE, NULL, v_created_by
  );
  ...
  INSERT INTO public.scope_acceptance_forms (
    ...
    '{"seed_marker":"SEED633","template_slug":"scope-acceptance-form","standards_based_group":"monitoring-controlling","sections":["Deliverable ID","Description","Acceptance Criteria","Verification Method","Acceptance Decision","Accepted By","Acceptance Date"],"notes":"PMO master template scaffold for Scope Validation / Deliverable Acceptance Master Template. Copy to a project workspace and customise."}'::jsonb,
    'active', TRUE, NULL, v_created_by
  );
  ...
  INSERT INTO public.project_closure_checklists (
    ...
    '{"seed_marker":"SEED633","template_slug":"project-closure-checklist","standards_based_group":"closing","sections":["Deliverable Acceptance","Financial Closure","Procurement Closure","Lessons Learned","Resource Release","Archive"],"notes":"PMO master template scaffold for Project Closure Checklist Master Template. Copy to a project workspace and customise."}'::jsonb,
    'active', TRUE, NULL, v_created_by
  ...
  INSERT INTO public.contract_closure_documents (
    ...
    '{"seed_marker":"SEED633","template_slug":"contract-closure-document","standards_based_group":"closing","sections":["Contract Reference","Vendor / Supplier","Deliverables Status","Final Payments","Open Issues","Release of Claims","Closure Approval"],"notes":"PMO master template scaffold for Contract Closure Document Master Template. Copy to a project workspace and customise."}'::jsonb,
    'active', TRUE, NULL, v_created_by
  );
