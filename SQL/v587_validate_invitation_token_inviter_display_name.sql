-- v587: Prefer inviter first + last name (or full_name) for "Sent by" on accept page
-- Run after v586_invitation_invitee_name.sql
...
COMMENT ON FUNCTION public.validate_invitation_token(VARCHAR) IS
  'Validates invitation token; returns invitee name, inviter display name, org, and project planned dates.';
