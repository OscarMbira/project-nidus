...
BEGIN
  ...
  VALUES
    ...
    ('pm_industry_templates_browse', 'Industry Templates', 'Browse PMO industry plan blueprints', v_s14, 2, 50, '/platform/industry-templates', 'layers', TRUE, TRUE),
    ('pm_industry_plan', 'My Industry Plan', 'Project industry plan copy', v_s14, 2, 60, '/platform/projects/__PROJECT__/industry-plan', 'map', TRUE, TRUE)
