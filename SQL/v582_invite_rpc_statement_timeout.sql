-- ============================================================================
-- v582: Prevent hung invitation RPC (statement_timeout inside function)
-- ============================================================================
-- Run after v579 if invites still time out. Safe to re-run.
-- ============================================================================
...
BEGIN
  ...
  LOOP
    ...
    dropped := dropped + 1;
  END LOOP;
  RAISE NOTICE 'v582: dropped % insert_project_invitation_as_pmo_admin overload(s)', dropped;
END $$;
...
DO $$ BEGIN RAISE NOTICE 'v582_invite_rpc_statement_timeout.sql applied'; END $$;
