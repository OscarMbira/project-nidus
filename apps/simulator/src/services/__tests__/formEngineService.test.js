...
describe('formEngineService template builder helpers', () => {
  ...
  describe('resolveEntityPolicyChain (sim schema: practice_* tables)', () => {
    ...
    it('a practice project linked to both a portfolio and a programme resolves Portfolio before Programme, then itself', async () => {
      mockTableResults({
        practice_portfolio_projects: { data: { practice_portfolio_id: 'pf-1' }, error: null },
        practice_programme_projects: { data: { practice_programme_id: 'pg-1' }, error: null },
      })
      const { resolveEntityPolicyChain } = await import('../formEngineService')
    ...
    it('a practice project linked to neither resolves to just itself', async () => {
      mockTableResults({})
      const { resolveEntityPolicyChain } = await import('../formEngineService')
    ...
    it('an orphan practice programme (no practice_portfolio_id) resolves to just itself', async () => {
      mockTableResults({ practice_programmes: { data: { practice_portfolio_id: null }, error: null } })
      const { resolveEntityPolicyChain } = await import('../formEngineService')
    ...
    it('a practice programme linked to a portfolio resolves Portfolio then itself', async () => {
      mockTableResults({ practice_programmes: { data: { practice_portfolio_id: 'pf-2' }, error: null } })
      const { resolveEntityPolicyChain } = await import('../formEngineService')
    ...
    it('a practice portfolio is a leaf — resolves to just itself', async () => {
      const { resolveEntityPolicyChain } = await import('../formEngineService')
