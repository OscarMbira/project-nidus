...
import { purgeAllSidebarMenuCaches } from '@nidus/shared/utils/menuCacheUtils'
...
export async function renameMenuItem(menuItemId, newLabel) {
  const { data, error } = await platformDb.rpc('rename_menu_item', {
