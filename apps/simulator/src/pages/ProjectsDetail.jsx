...
import { mapDbProjectToWizardForm, normalizeEmbeddedList } from '@nidus/shared/utils/projectWizardFormUtils'
        ...
        <div className="flex items-start justify-between mb-4">
          ...
          <div className="flex flex-wrap gap-2 items-center">
            ...
            <button
              ...
              disabled={isRecordLifecycleLocked(project.record_status)}
              className="px-4 py-2 bg-yellow-600 hover:bg-yellow-700 text-white font-medium rounded-lg transition-colors flex items-center gap-2 disabled:cursor-not-allowed disabled:opacity-50"
            >
