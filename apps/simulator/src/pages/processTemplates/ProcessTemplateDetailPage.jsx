  ...
  return (
    <div className="p-4 md:p-6 max-w-3xl mx-auto space-y-4">
      ...
      <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3">
        <div>
          <h1 className="text-xl font-bold text-gray-900 dark:text-gray-100">{row.title || 'Untitled'}</h1>
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <div className="relative">
            ...
            {exportOpen && (
              <div className="absolute right-0 mt-1 z-10 rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 py-1 min-w-[100px]">
                <button type="button" onClick={() => handleExport('print')} className="block w-full text-left px-3 py-1.5 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-800">
                  Print
                </button>
              </div>
            )}
