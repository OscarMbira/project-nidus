...
export default function QualityManagement() {
  ...
  const [qualityOrgAccountId, setQualityOrgAccountId] = useState(null);
  ...
  useEffect(() => {
    fetchProjects();
    getCurrentUserAccountId().then((id) => setQualityOrgAccountId(id));
  }, []);
  ...
  const settingsAccountId = qualityOrgAccountId || selectedProject?.account_id || null;
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      {pageMode === 'settings' ? (
        <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6 space-y-4">
          ...
          {settingsAccountId && selectedProjectId ? (
