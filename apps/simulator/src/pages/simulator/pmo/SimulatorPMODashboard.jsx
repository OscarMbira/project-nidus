...
export default function SimulatorPMODashboard() {
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-6">
      <RoleWelcomeTips roleId="pmo_analyst" />
      <div className="mb-2">
        <h1 className="text-3xl font-bold text-gray-900 dark:text-white">PMO Analyst Dashboard</h1>
        <p className="mt-2 text-gray-600 dark:text-gray-400">
          Governance, compliance, reporting, and methodology support across practice projects
        </p>
      </div>
      ...
      <LearningPathWidget roleId="pmo_analyst" />
    </div>
  )
}
