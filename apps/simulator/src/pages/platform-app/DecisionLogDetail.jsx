...
export default function DecisionLogDetail() {
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      navigate(`/simulator/governance/decisions${projectId ? `?projectId=${projectId}` : ''}`)
    } catch (e) {
      ...
      <div className="max-w-3xl mx-auto space-y-5">
        ...
        <div className="flex items-center gap-3">
          ...
          <RowActionButton
            variant="edit"
            label="Edit decision"
            onClick={() => navigate(`/simulator/governance/decisions/${id}/edit${projectId ? `?projectId=${projectId}` : ''}`)}
          />
          <RowActionButton
            variant="delete"
