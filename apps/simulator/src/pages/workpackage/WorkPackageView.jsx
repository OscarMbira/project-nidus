          ...
          <div className="p-6">
            {activeTab === 'overview' && (
              <div className="space-y-6">
                ...
                {project?.account_id && workPackage.project_id && (
            ...
            {activeTab === 'settings' && (
              <div className="space-y-3">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400">
                  Inherit fields from PMO / portfolio / programme defaults, then disable or add local
                  fields for this project. Mandatory lock prevents lower tiers from turning a field off.
                </p>
                {project?.account_id && workPackage?.project_id ? (
                  <TierFieldCustomisationPanel
                    ...
                    tier="project"
                    entityType="project"
                    entityId={workPackage.project_id}
