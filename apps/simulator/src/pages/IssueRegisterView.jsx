...
import { Plus, AlertCircle, FileText, AlertTriangle, HelpCircle, Filter, Search, BarChart3, ExternalLink, Settings } from 'lucide-react'
...
export default function IssueRegisterView() {
  ...
  const [viewMode, setViewMode] = useState('list') // 'list', 'analytics', 'settings'
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
          ...
          {issueOrgAccountId && projectId ? (
            <TierFieldCustomisationPanel
              ...
              entityType="project"
              entityId={projectId}
              entityName={issueProjectName || 'Project'}
