...
import { savePreferredRole } from '../../services/sim/rolePreferenceService'
export default function SimulatorWelcome() {
  ...
  const handleComplete = async () => {
    ...
    try {
      ...
      if (preferredRole) {
        await savePreferredRole(user.id, preferredRole)
      }

      showToast('success', 'Welcome to Simulator!')
      navigate(preferredRole ? '/simulator/role-selection' : '/simulator/dashboard', { replace: true })
    } catch (error) {
