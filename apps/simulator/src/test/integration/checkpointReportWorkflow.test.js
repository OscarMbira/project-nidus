...
// vi.mock() factories are hoisted above all other code, including const
// declarations — referencing mockSupabase directly here threw "Cannot
// access 'mockSupabase' before initialization". vi.hoisted() is the
// documented fix: it hoists ALONGSIDE vi.mock(), in the same order, so the
// value exists by the time the factory runs.
