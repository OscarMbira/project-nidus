...
export default function QualityRegisterForm({
  ...
  }, [projectId, accountIdProp, item?.project_id, formData.project_id]);
  ...
  return (
    ...
    >
      <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          {item?.id && accountId && (projectId || formData.project_id || item?.project_id) && (
            <InheritedQualityFields
              db={simDb}
              accountId={accountId}
              projectId={projectId || formData.project_id || item.project_id}
              practiceProjectId={projectId || formData.project_id || item.project_id}
