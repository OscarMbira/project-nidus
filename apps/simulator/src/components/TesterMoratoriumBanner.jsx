...
import { isTesterSubscription } from '../services/subscriptionService'
      ...
      <div className="flex flex-wrap items-start gap-3">
        ...
        <div className="min-w-0 flex-1">
          ...
          <p className="mt-1 text-sm text-gray-400">
            {expired
              ? 'Subscribe to continue unlimited scenarios and certificates.'
              : days != null
                ? `Tester access ends in ${days} day${days === 1 ? '' : 's'}.`
