  ...
  project_coordinator: [
    {
      id: 'coord_1',
      category: 'scheduling',
      question: 'How confident are you maintaining project schedules and action logs?',
      type: 'scale',
      options: [
  ...
  pmo_analyst: [
    {
      id: 'pmo_1',
      category: 'governance',
      question: 'How familiar are you with PMO reporting standards and compliance checks?',
      type: 'scale',
      options: [
        { value: 1, label: 'Beginner', score: 0 },
        { value: 2, label: 'Basic', score: 1 },
  ...
  project_manager: [
    {
      id: 'pm_1',
      category: 'delivery',
      question: 'How comfortable are you leading end-to-end project delivery?',
      type: 'scale',
      options: [
        { value: 1, label: 'Beginner', score: 0 },
        { value: 2, label: 'Basic', score: 1 },
  ...
  programme_manager: [
    {
      ...
      question: 'How experienced are you managing cross-project dependencies?',
      type: 'scale',
      options: [
        { value: 1, label: 'Beginner', score: 0 },
        { value: 2, label: 'Basic', score: 1 },
  ...
  portfolio_manager: [
    {
      id: 'port_1',
      category: 'strategy',
      question: 'How confident are you prioritising investments against strategic objectives?',
      type: 'scale',
      options: [
        { value: 1, label: 'Beginner', score: 0 },
        { value: 2, label: 'Basic', score: 1 },
...
const SkillAssessment = () => {
  ...
  const [assessmentRole, setAssessmentRole] = useState(getStoredRole() || 'project_coordinator');
  ...
  const baseQuestions = [
    ...
    },
    {
      ...
      question: 'Which practice role are you assessing for?',
      type: 'multiple_choice',
      options: SIMULATOR_ROLE_LIST.map((role, index) => ({
        value: role.id,
        label: `${role.label} — ${role.level}`,
        score: index,
        role: role.id,
      })),
    },
  ...
  const questions = useMemo(() => {
    const roleQs = ROLE_QUESTIONS[assessmentRole] || [];
    return [...roleQs, ...baseQuestions];
  }, [assessmentRole]);

  const handleAnswer = (questionId, answer) => {
    if (questionId === 8 && answer) {
      setAssessmentRole(answer);
    }
    setAnswers({
      ...answers,
      [questionId]: answer,
  ...
  const calculateResults = () => {
    let totalScore = 0;
    let categoryScores = {};
    let recommendedRole = assessmentRole;
