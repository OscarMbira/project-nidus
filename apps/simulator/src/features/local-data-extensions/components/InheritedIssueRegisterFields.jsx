...
export const ISSUE_REGISTER_CATEGORY = 'issue_register'
export const ISSUE_REGISTER_SCREEN_CODE = 'issue_register'

/**
 * Renders tier-inherited Issue Register extra fields for an issue entity,
 * alongside fixed issue columns (v787, mirrors InheritedRiskRegisterFields / v785 Gap 4).
 */
export default function InheritedIssueRegisterFields({
  db,
  accountId,
  projectId = null,
  ...
  issueId,
  mode = 'edit',
  title = 'Issue Register additional fields',
}) {
  ...
  if (!definitions.length || !issueId) return null
  ...
  return (
    <CustomFieldRenderer
      ...
      entityType="issue"
      entityId={issueId}
      screenCode={ISSUE_REGISTER_SCREEN_CODE}
      mode={mode}
      title={title}
