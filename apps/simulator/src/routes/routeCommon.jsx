...
const {
  ...
  Register, PlatformRegister, SimulatorRegister, EmailConfirmation, VerifyEmail, InvitationAccept, RoleSelection,
  PlatformAccountSetup, PlatformChoice, OrganisationSetup, IndustrySelectionStep, ProfessionalRoleStep,
  EmailVerificationStep, RegistrationReviewStep, WorkspaceSetupStep, GettingStarted, OrganisationVerificationNotice,
  ...
  SimRequirementsCurrentProjectRedirect, SimRequirementDetailPage, SimTraceabilityMatrixPage, SimWBSBuilderPage,
  ...
  SimulatorRoleSelection, SimulatorPortfolioLayout, SimulatorProgrammeLayout, SimulatorCoordinatorLayout,
  SimulatorPortfolioDashboard, SimulatorProgrammeDashboard, SimulatorCoordinatorDashboard,
  SimulatorRolePracticePage, SimulationTurnView, SimulationComplete,
  LearningPathDashboard, LearningModule, SimulatorTMRedirect,
  CollaborativeSessionLobby, CollaborativeSessionRoom, CollaborativeSessionDebrief,
  SubscriptionAccessGate, TeamSeatClaimPage, TeamSeatsDashboard,
} = LP
