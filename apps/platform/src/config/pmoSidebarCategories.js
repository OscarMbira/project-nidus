...
export const PM_CATEGORY_DEFS = [
  ...
  { id: 'plat_pm_templates', label: 'Organizational Templates', order: 25 },
  { id: 'plat_pm_project_templates', label: 'Project Templates', order: 26 },
  { id: 'plat_pm_project_documents', label: 'Project Documents', order: 27 },
