/**
 * Local Vite alias copy of packages/shared/src/utils/entityRouteParam.js
 * (@nidus/shared/utils maps to each app's src/utils). Keep in sync with the package file.
 *
 * Registry stays in @nidus/shared (config is not locally aliased).
 */
import { platformDb, simDb } from '@nidus/supabase'
import { isLikelyDatabaseUuid } from './isUuid'
import { ENTITY_URL_REGISTRY } from '@nidus/shared/config/entityUrlRegistry.js'
