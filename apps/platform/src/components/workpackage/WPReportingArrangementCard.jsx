/**
 * Work Package Reporting Arrangement Card Component
 * Displays a single Work Package reporting arrangement
 */

import { Edit2, Trash2, FileText, User } from 'lucide-react'

const REPORT_TYPE_COLORS = {
  checkpoint_report: 'bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-300',
  highlight_report: 'bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-300',
  exception_report: 'bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-300',
  ad_hoc: 'bg-yellow-100 text-yellow-800 dark:bg-yellow-900/30 dark:text-yellow-300',
  other: 'bg-gray-100 text-gray-800 dark:bg-gray-700 dark:text-gray-300'
}

export default function WPReportingArrangementCard({ arrangement, mode = 'view', onEdit, onDelete }) {
  const typeColor = REPORT_TYPE_COLORS[arrangement.report_type] || REPORT_TYPE_COLORS.other
