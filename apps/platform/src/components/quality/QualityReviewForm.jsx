...
export default function QualityReviewForm({
  ...
  useEffect(() => {
    ...
    const pid = projectId || review?.project_id;
    if (!pid) {
      setAccountId(null);
      return;
    }
  ...
  }, [projectId, accountIdProp, review?.project_id]);
  ...
  return (
    <FormSurface
      variant={variant}
      title={review ? 'Edit Quality Review' : 'Create Quality Review'}
      icon={CheckCircle}
      onClose={onCancel}
    >
