    ...
    >
      ...
      {formTab === 'audit' && (
        !recordData?.id ? (
          ...
          <AuditDetailsPanel description="How this record is labelled and classified, and when it was created.">
            <AuditCard title="Identity" description="How this record is labelled and tracked.">
              <AuditField label="Record name" value={recordData.record_name} />
              <AuditField label="Type" value={humanizeAuditToken(recordData.record_type)} />
              <AuditField label="Mandatory" value={recordData.is_mandatory !== false ? 'Yes' : 'No'} />
            </AuditCard>
            <AuditCard title="Record history" description="When this record was created.">
              <AuditTimestampPair dateLabel="Created at" value={recordData.created_at} />
            </AuditCard>
          </AuditDetailsPanel>
        )
      )}
