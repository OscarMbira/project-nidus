/**
 * Product Description Revision History Component
 */

import { History, User, Calendar } from 'lucide-react'

export default function ProductDescriptionRevisionHistory({ revisionHistory }) {
          ...
          <div className="flex items-start justify-between mb-2">
            <div className="flex items-center gap-2">
              ...
              <span className="font-semibold text-gray-900 dark:text-white">
                Revision {new Date(revision.revision_date).toLocaleDateString()}
              </span>
              {revision.previous_revision_date && (
                <span className="text-sm text-gray-500 dark:text-gray-400">
                  (from {new Date(revision.previous_revision_date).toLocaleDateString()})
                </span>
              )}
            </div>
