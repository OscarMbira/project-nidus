...
import { createBrief, getBriefById, getBriefByProject, updateBrief, deleteBrief, createBriefFromMandate } from '../projectBriefService'
...
describe('Project Brief Service', () => {
  ...
  describe('getBriefByProject', () => {
    it('returns null when project id is missing', async () => {
      await expect(getBriefByProject(null)).resolves.toBeNull()
      await expect(getBriefByProject('null')).resolves.toBeNull()
    })
  })
