...
/**
 * v848 / v864 — Process Templates Hub landing redirects to Project Templates
 * at /platform/templates/project/<projectKey>.
 */
  ...
  if (!projectId) {
    return (
      <div className="mx-auto max-w-3xl px-4 py-12 text-center text-gray-700 dark:text-gray-300">
        <p>Select a project first to capture process-document data under Project Templates.</p>
        <Link
