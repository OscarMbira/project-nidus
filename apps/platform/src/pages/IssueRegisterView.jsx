...
export default function IssueRegisterView() {
  ...
  useEffect(() => {
    if (initialQueryFilter.filter === 'open') {
      setFilters({ ...ISSUE_EMPTY_FILTERS, status_not_in: ISSUE_OPEN_STATUSES_EXCLUDED })
      setViewMode('register')
    } else if (initialQueryFilter.filter === 'critical') {
      setFilters({ ...ISSUE_EMPTY_FILTERS, critical_only: true })
      setViewMode('register')
    } else if (initialQueryFilter.filter === 'overdue') {
      setFilters({ ...ISSUE_EMPTY_FILTERS, overdue_actions_only: true })
      setViewMode('register')
    } else if (initialQueryFilter.filter === 'all') {
      setFilters(ISSUE_EMPTY_FILTERS)
      setViewMode('register')
    }
