...
export default function RequirementsRegister() {
  ...
  const { projectId: contextProjectId, routeKey: contextRouteKey, loading: projectLoading } = usePlatformProjectId()
  const projectId = routeProjectId || contextProjectId
  const routeKey = contextRouteKey || projectId
          ...
          <div className="flex flex-wrap items-center justify-end gap-2">
            ...
            {canEdit && (
              <>
                ...
                <Link
                  to={platformProjectPath(routeKey, 'scope', 'requirements', 'new')}
      ...
      {pageTab === 'dashboard' && (
        <div className="space-y-6" role="tabpanel" aria-label="Requirements dashboard">
          ...
          <RegisterOpenItemsWidget
            ...
            onRowClick={(r) => navigate(platformProjectPath(routeKey, 'scope', 'requirements', r.requirement_code || r.id))}
      ...
      {loading ? (
                  ...
                  >
                    <div className="inline-flex items-center gap-1 justify-end">
                      <RowActionButton
                        ...
                        onClick={() => navigate(platformProjectPath(routeKey, 'scope', 'requirements', r.requirement_code || r.id))}
                      />
                      <RowActionButton
                        variant="edit"
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {filtered.map((r, index) => (
            <Link
              key={r.id}
              to={platformProjectPath(routeKey, 'scope', 'requirements', r.requirement_code || r.id)}
