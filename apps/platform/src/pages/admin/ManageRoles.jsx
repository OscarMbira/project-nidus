...
export default function ManageRoles() {
  ...
  const openCreate = () => navigate('/platform/admin/manage-roles/create')
  const openEdit = (role) => navigate(`/platform/admin/manage-roles/${role.role_name}/edit`)
  const openView = (role) => navigate(`/platform/admin/manage-roles/${role.role_name}`)
