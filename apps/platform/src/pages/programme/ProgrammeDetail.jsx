          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6 space-y-8">
            <div>
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400 mb-4">
                Fields inherited from the portfolio or PMO default, with the option to override or add fields local to this programme.
              </p>
              {accountId ? (
                <TierFieldCustomisationPanel
                  ...
                  entityId={programmeUuid}
                  entityName={programme?.programme_name}
                />
              ) : (
            ...
            <div>
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400 mb-4">
                Enable/disable and require fields on shared forms, or add fields local to this programme.
              </p>
              {accountId && (
                <TierFormPolicyPanel
                  mode="platform"
