...
} from '@nidus/shared/utils/projectWizardFormUtils'
import {
  getProjectPortfolio,
...
import RecordLifecycleFieldLock, { RecordLifecycleLockBanner, isRecordLifecycleLocked } from '@nidus/ui/RecordLifecycleFieldLock'
...
export default function ProjectsEdit() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault()
    if (isRecordLifecycleLocked(project?.record_status)) {
      toast.error('This project is locked for editing until the pending change is approved or rejected.')
      return
    }
  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-8 sm:px-6 lg:px-8">
      ...
      {isRecordLifecycleLocked(project?.record_status) && (
        <div className="mb-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <RecordLifecycleFieldLock recordStatus={project?.record_status}>
        <ProjectWizardPanels
          mode="edit"
          activeTab={activeTab}
          formData={formData}
