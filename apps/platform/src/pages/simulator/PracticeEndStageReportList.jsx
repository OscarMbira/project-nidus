/**
 * Practice End Stage Report List Page
 */
...
export default function PracticeEndStageReportList() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="mb-6 flex justify-between items-center flex-wrap gap-3">
        <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Practice End Stage Reports</h1>
        <div className="flex gap-2">
          <ExportListMenu columns={PRACTICE_END_STAGE_COLUMNS} data={reports} baseFilename="PracticeEndStageReports" disabled={!reports.length} />
          <button onClick={() => navigate(`/simulator/practice-end-stage-reports/create?projectId=${projectId}`)} className="inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700">
