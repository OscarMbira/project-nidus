...
import TesterMoratoriumBanner from '../components/TesterMoratoriumBanner.jsx';
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {(summary?.subscriptions || [])
          ...
          .map((s) => (
            <TesterMoratoriumBanner
              key={`${s.platform}-${s.subscription_id}`}
              subscription={s}
              pricingPath={s.platform === 'simulator' ? '/simulator/pricing' : '/pricing'}
            />
          ))}
