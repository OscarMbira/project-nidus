...
const federationPlugin = createFederationHostPlugin({ modules: PLATFORM_MODULES, env })
...
export default mergeConfig(
  createBaseViteConfig({
    ...
    pwaManifest: path.resolve(repoRoot, 'platform/manifest.json'),
    manualChunksExtra: {
      'platform-core': [
        path.resolve(__dirname, 'src/routes/platformRoutes.jsx'),
